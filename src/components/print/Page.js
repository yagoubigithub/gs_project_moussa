...
<p>email : {this.props.row[0].devis.maitre_douvrage_email}</p>
        ...
        <div className="print-page-content">
          ...
          <div className="page-row pt-1">
            ...
            <div className="page-col " style={{flex : 4}}>
              ...
              <h5>Total TVA : {round((Number.parseFloat(this.props.row[0].prixTotale) * this.props.row[0].devis["tva"]) / 100)} DA</h5>
            
            
              <h5>Total TTC : {round((Number.parseFloat(this.props.row[0].prixTotale))  + ((Number.parseFloat(this.props.row[0].prixTotale) * this.props.row[0].devis["tva"]) / 100))} DA</h5>

              <h5>Remise sur le Total : {round(this.props.row[0].devis.remise)} DA
           </h5>
  ...
  <h5>
                Total a Payer :{" "}
                {round((Number.parseFloat(this.props.row[0].prixTotale))  + ((Number.parseFloat(this.props.row[0].prixTotale) * this.props.row[0].devis["tva"]) / 100) -
