...
import { addToCorbeille, getMaitreDouvrage , getLogo , undoDeleteMaitreDouvrage } from '../../store/actions/maitreDouvrageAction';
  ...
  render() {
    ...
    const columns = [
     
      {
        ...
        Header: "Numéro de rg ou agrément",
        accessor: 'rg',
       width : 250 ,
        Cell: props =>
        (<div className="cell" >{props.value !== "undefined" ? props.value : ""}</div>)
        ...
        
          {
            ...
            Cell: props => 
            {
              if (this.props.type === "corbeille") {
                ...
                size="small"
                onClick={() => this.props.undoDeleteMaitreDouvrage(props.value)}
              >
                <UndoIcon className="black" fontSize="small"></UndoIcon>
              </IconButton></div> ;
              }else{
                return( <div className="cell">
                <IconButton size="small" onClick={()=>{this.handleCloseOpenGallerieVoiture();this.props.getLogo(props.value)}}>
                ...
                <IconButton size="small">
                  <Link to={`/maitre_douvrage/modifier/${props.value}`}><EditIcon className="black" fontSize="small"></EditIcon></Link>
                </IconButton>
        ...
        columns.unshift(
          {
            ...
            filterable: false,
            Cell: props => {
            return (  <div className="cell"><input type="radio" name="select-voiture" checked={props.value === this.state.maitreDouvrageSelected.id} onChange={()=>this.handleSelectOneChange(props.original)} /></div>)
            }
          }
        )
      }
      ...
      <Fragment>
        ...
        <DialogContent dividers={true}>
          ...
          <div>
            ...
            {this.state.logo !== "" ? <img src={this.state.logo }  style={{width : "100%", maxHeight : 200, height : "100%"}}/> : <p>No  logo</p>}
            </Grid>
          </div>
        </DialogContent>
      </Dialog>
